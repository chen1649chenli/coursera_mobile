...
.controller('DishDetailController', ['$scope', '$ionicModal','$stateParams', 'menuFactory', 'favoriteFactory','baseURL','$ionicPopover', function($scope, $ionicModal,$stateParams, menuFactory, favoriteFactory,baseURL,$ionicPopover) {
